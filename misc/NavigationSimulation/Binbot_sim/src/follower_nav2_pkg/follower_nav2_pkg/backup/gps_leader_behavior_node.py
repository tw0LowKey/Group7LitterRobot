...
class GPSLeaderBehaviorNode(Node):
    """
    Simulation GPS leader behaviour node for lawnmower coverage pattern.

    Subscribes:
        /odom       — leader position (x, y) and orientation
        /gps/fix    — leader lat/lon for LoRa broadcast and reference point
        /call_bin   — litter detection trigger
        /comms/follower_to_leader_tx  — follower status

    Publishes:
        /comms/leader_to_follower_tx  — leader pose broadcast

    Sends goals to Nav2 action server:
        /navigate_to_pose

    Service:
        /area_coord  — receives area coordinates and generates waypoints

    States:
        WAITING_MISSION  — waiting for area coordinates via service
    ...
    def __init__(self):
        ...
        # ================================================================
        # Area Coordinate Service (sim hosts this directly)
        # ================================================================
    ...
    def print_startup_info(self):
        self.get_logger().info("=== Sim GPS Leader Behaviour Node Started ===")
        ...
        self.get_logger().info("Waiting for mission via /area_coord service...")
    ...
    def follower_status_callback(self, msg: FollowerStatus):
        """Handle incoming status from follower."""
    ...
    # ================================================================
    # Area Coordinate Service (sim hosts directly)
    # ================================================================
    ...
    def odom_callback(self, msg: Odometry):
        """Track leader position and orientation from odometry."""
    ...
    def navsat_callback(self, msg: NavSatFix):
        """Track leader GPS for lat/lon broadcast and reference point."""
