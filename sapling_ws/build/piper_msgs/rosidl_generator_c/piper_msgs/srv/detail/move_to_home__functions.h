...
#ifndef PIPER_MSGS__SRV__DETAIL__MOVE_TO_HOME__FUNCTIONS_H_
#define PIPER_MSGS__SRV__DETAIL__MOVE_TO_HOME__FUNCTIONS_H_
...
/// Initialize srv/MoveToHome message.
/**
...
/// Finalize srv/MoveToHome message.
/**
...
/// Create srv/MoveToHome message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * piper_msgs__srv__MoveToHome_Request__init().
...
/// Destroy srv/MoveToHome message.
/**
 * It calls
 * piper_msgs__srv__MoveToHome_Request__fini()
...
/// Check for srv/MoveToHome message equality.
/**
...
/// Initialize array of srv/MoveToHome messages.
/**
...
/// Finalize array of srv/MoveToHome messages.
/**
 * It calls
 * piper_msgs__srv__MoveToHome_Request__fini()
...
/// Create array of srv/MoveToHome messages.
/**
 * It allocates the memory for the array and calls
 * piper_msgs__srv__MoveToHome_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/MoveToHome messages.
/**
 * It calls
 * piper_msgs__srv__MoveToHome_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/MoveToHome message array equality.
/**
...
/// Copy an array of srv/MoveToHome messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * piper_msgs__srv__MoveToHome_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_piper_msgs
...
/**
 * It calls
 * piper_msgs__srv__MoveToHome_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_piper_msgs
...
/**
 * It allocates the memory for the array and calls
 * piper_msgs__srv__MoveToHome_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_piper_msgs
...
/**
 * It calls
 * piper_msgs__srv__MoveToHome_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // PIPER_MSGS__SRV__DETAIL__MOVE_TO_HOME__FUNCTIONS_H_
