...
piper_msgs__srv__MoveToPose_Request__init(piper_msgs__srv__MoveToPose_Request * msg)
{
  ...
  if (!geometry_msgs__msg__Pose__init(&msg->pose)) {
    piper_msgs__srv__MoveToPose_Request__fini(msg);
    return false;
  }
  return true;
}
...
piper_msgs__srv__MoveToPose_Request__create()
{
  ...
  piper_msgs__srv__MoveToPose_Request * msg = (piper_msgs__srv__MoveToPose_Request *)allocator.allocate(sizeof(piper_msgs__srv__MoveToPose_Request), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(piper_msgs__srv__MoveToPose_Request));
  bool success = piper_msgs__srv__MoveToPose_Request__init(msg);
  if (!success) {
...
piper_msgs__srv__MoveToPose_Request__Sequence__init(piper_msgs__srv__MoveToPose_Request__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  piper_msgs__srv__MoveToPose_Request * data = NULL;

  if (size) {
    data = (piper_msgs__srv__MoveToPose_Request *)allocator.zero_allocate(size, sizeof(piper_msgs__srv__MoveToPose_Request), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = piper_msgs__srv__MoveToPose_Request__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        piper_msgs__srv__MoveToPose_Request__fini(&data[i - 1]);
      }
...
piper_msgs__srv__MoveToPose_Request__Sequence__fini(piper_msgs__srv__MoveToPose_Request__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      piper_msgs__srv__MoveToPose_Request__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  piper_msgs__srv__MoveToPose_Request__Sequence * array = (piper_msgs__srv__MoveToPose_Request__Sequence *)allocator.allocate(sizeof(piper_msgs__srv__MoveToPose_Request__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = piper_msgs__srv__MoveToPose_Request__Sequence__init(array, size);
  if (!success) {
...
piper_msgs__srv__MoveToPose_Request__Sequence__destroy(piper_msgs__srv__MoveToPose_Request__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    piper_msgs__srv__MoveToPose_Request__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
piper_msgs__srv__MoveToPose_Request__Sequence__are_equal(const piper_msgs__srv__MoveToPose_Request__Sequence * lhs, const piper_msgs__srv__MoveToPose_Request__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!piper_msgs__srv__MoveToPose_Request__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  piper_msgs__srv__MoveToPose_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(piper_msgs__srv__MoveToPose_Request);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    piper_msgs__srv__MoveToPose_Request * data =
      (piper_msgs__srv__MoveToPose_Request *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!piper_msgs__srv__MoveToPose_Request__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          piper_msgs__srv__MoveToPose_Request__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!piper_msgs__srv__MoveToPose_Request__copy(
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  piper_msgs__srv__MoveToPose_Response * msg = (piper_msgs__srv__MoveToPose_Response *)allocator.allocate(sizeof(piper_msgs__srv__MoveToPose_Response), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(piper_msgs__srv__MoveToPose_Response));
  bool success = piper_msgs__srv__MoveToPose_Response__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
piper_msgs__srv__MoveToPose_Response__destroy(piper_msgs__srv__MoveToPose_Response * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    piper_msgs__srv__MoveToPose_Response__fini(msg);
  }
  allocator.deallocate(msg, allocator.state);
}
...
piper_msgs__srv__MoveToPose_Response__Sequence__init(piper_msgs__srv__MoveToPose_Response__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  piper_msgs__srv__MoveToPose_Response * data = NULL;

  if (size) {
    data = (piper_msgs__srv__MoveToPose_Response *)allocator.zero_allocate(size, sizeof(piper_msgs__srv__MoveToPose_Response), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = piper_msgs__srv__MoveToPose_Response__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        piper_msgs__srv__MoveToPose_Response__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
piper_msgs__srv__MoveToPose_Response__Sequence__fini(piper_msgs__srv__MoveToPose_Response__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      piper_msgs__srv__MoveToPose_Response__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  piper_msgs__srv__MoveToPose_Response__Sequence * array = (piper_msgs__srv__MoveToPose_Response__Sequence *)allocator.allocate(sizeof(piper_msgs__srv__MoveToPose_Response__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = piper_msgs__srv__MoveToPose_Response__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
piper_msgs__srv__MoveToPose_Response__Sequence__destroy(piper_msgs__srv__MoveToPose_Response__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    piper_msgs__srv__MoveToPose_Response__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
piper_msgs__srv__MoveToPose_Response__Sequence__are_equal(const piper_msgs__srv__MoveToPose_Response__Sequence * lhs, const piper_msgs__srv__MoveToPose_Response__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!piper_msgs__srv__MoveToPose_Response__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  piper_msgs__srv__MoveToPose_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(piper_msgs__srv__MoveToPose_Response);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    piper_msgs__srv__MoveToPose_Response * data =
      (piper_msgs__srv__MoveToPose_Response *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!piper_msgs__srv__MoveToPose_Response__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          piper_msgs__srv__MoveToPose_Response__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!piper_msgs__srv__MoveToPose_Response__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
