...
class Metaclass_MoveToPose(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from piper_msgs.srv import _move_to_pose
...
class MoveToPose(metaclass=Metaclass_MoveToPose):
    from piper_msgs.srv._move_to_pose import MoveToPose_Request as Request
    from piper_msgs.srv._move_to_pose import MoveToPose_Response as Response
