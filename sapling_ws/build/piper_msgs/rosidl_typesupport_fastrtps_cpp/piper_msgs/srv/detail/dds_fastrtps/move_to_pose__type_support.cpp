...
#include "piper_msgs/srv/detail/move_to_pose__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const piper_msgs::srv::MoveToPose_Request & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  piper_msgs::srv::MoveToPose_Request & ros_message)
{
  // Member: pose
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = piper_msgs::srv::MoveToPose_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const piper_msgs::srv::MoveToPose_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<piper_msgs::srv::MoveToPose_Request *>(
    untyped_ros_message);
...
{
  return &piper_msgs::srv::typesupport_fastrtps_cpp::_MoveToPose_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, piper_msgs, srv, MoveToPose_Request)() {
  return &piper_msgs::srv::typesupport_fastrtps_cpp::_MoveToPose_Request__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_piper_msgs
cdr_serialize(
  const piper_msgs::srv::MoveToPose_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: success
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  piper_msgs::srv::MoveToPose_Response & ros_message)
{
  // Member: success
  {
    uint8_t tmp;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = piper_msgs::srv::MoveToPose_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const piper_msgs::srv::MoveToPose_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<piper_msgs::srv::MoveToPose_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &piper_msgs::srv::typesupport_fastrtps_cpp::_MoveToPose_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, piper_msgs, srv, MoveToPose_Response)() {
  return &piper_msgs::srv::typesupport_fastrtps_cpp::_MoveToPose_Response__handle;
}
...
{
  return &piper_msgs::srv::typesupport_fastrtps_cpp::_MoveToPose__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, piper_msgs, srv, MoveToPose)() {
  return &piper_msgs::srv::typesupport_fastrtps_cpp::_MoveToPose__handle;
}
