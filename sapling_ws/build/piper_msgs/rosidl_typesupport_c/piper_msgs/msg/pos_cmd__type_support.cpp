...
static const _PosCmd_type_support_symbol_names_t _PosCmd_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, piper_msgs, msg, PosCmd)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, piper_msgs, msg, PosCmd)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, piper_msgs, msg, PosCmd)() {
  return &::piper_msgs::msg::rosidl_typesupport_c::PosCmd_message_type_support_handle;
}
