...
class GraspNode(Node):
    ...
    def _feasibility_reason(self, points, grasp_pos, grasp_rot):
        ...
        in_palm_x = np.abs(x) <= outer_x + GRIPPER_PALM_EXTRA_X
    ...
    def _build_gripper_markers(self, header, idx, pos, rot, quat):
        ...
        markers.append(_make_cube_marker(
            ...
            palm_world, quat,
            scale_xyz=[GRIPPER_WIDTH_MAX + 2 * GRIPPER_FINGER_THICK + 2 * GRIPPER_PALM_EXTRA_X, GRIPPER_PALM_WIDTH_Y, GRIPPER_PALM_THICK],
