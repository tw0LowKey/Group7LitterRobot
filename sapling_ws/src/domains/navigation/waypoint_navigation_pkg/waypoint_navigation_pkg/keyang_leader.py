...
from sapling_interfaces.srv import AreaCoord
...
class GPSLeaderBehaviorNode(Node):
    ...
    States:
        WAITING_MISSION  — waiting for area coordinates
    ...
    def publish_leader_pose(self):
        ...
        msg.litter_detected = self.litter_flag
