...
def generate_launch_description(): 
    ...
    bridge = Node(
        ...
        parameters=[{
            "config_file": os.path.join(get_package_share_directory("robot_description_nav"), "config", "bridge_gazebo.yaml"),
    ...
    # 2. Robot Description
    scout_description_file = os.path.join(get_package_share_directory("robot_description_nav"), "urdf", "robot.urdf.xacro")
    ...
    scout_description = {"robot_description_nav": ParameterValue(scout_description_content, value_type=str)}
    ...
    spawn_robot_urdf_node = Node(
        ...
        package="ros_gz_sim",
        executable="create",
        arguments=["-name","scout_v2","-topic","/robot_description_nav","-x","0","-y","0","-z","0.2"],
        output="screen",
    )
