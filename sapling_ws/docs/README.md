...
The following folder is seperated into an introductory hardware setup file `Assembly Instructions.pdf` and introductory software setup markdown file `Software Setup.md`, for the entire system of SAPLInG including both PickBot and BinBot, followed by folders for each subsystem of SAPLInG.
