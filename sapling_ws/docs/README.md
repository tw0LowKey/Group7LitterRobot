...
The following folder is seperated into an introductory hardware setup markdown file (Hardware Setup.md) and introductory software setup markdown file (Software Setup.md), for the entire system of SAPLInG including both PickBot and BinBot, followed by folders for each subsystem of SAPLInG.
