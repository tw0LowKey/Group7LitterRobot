...
def launch_setup(context, *args, **kwargs):
    ...
    waypoint_pkg = get_package_share_directory("waypoint_navigation_pkg")
    ...
    robot_description_launch = IncludeLaunchDescription(
        PythonLaunchDescriptionSource(
            os.path.join(robot_desc_pkg, "launch", "Fb_real_robot.launch.py")
        )
    )

    # ============================================================
    # NAV2 / SLAM (namespaced to /follower)
    # ============================================================

    nav2_launch_file = os.path.join(
        rm_loc_pkg, "launch", "bringup_launch.py"
    )

    nav2_params_file = os.path.join(
        rm_nav_pkg, "config", "nav2_real_params_follower.yaml"
    )
    ...
    return [
        ...
        # (after Nav2 has time to start up)
        # --------------------------------------------------------
